module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      dist: {
        ...
        dest: '<%= dest %>/<%= basePath %>/js/two.way.picker.js',
        nonull: true
      }
    },
    ...
    less: {
      dist: {
        ...
        files: {
          '<%= dest %>/<%= basePath %>/css/two.way.picker.css': 'app/styles/two.way.picker.less',
        }
      }
    },
  ...
  grunt.registerTask('default', ['jshint', 'concat', 'less', 'copy:config', 'copy:views', 'copy:dll']);
