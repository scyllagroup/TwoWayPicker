...
using TwoWayPicker.Core.PropertyValueConverters.Utilities;
...
namespace Britax.Core.Extensions.PropertyValueConverters
{
    //Lifted from Umbraco Core **********
    ...
    /// The multi node tree picker property editor value converter.
    /// </summary>
    public class TwoWayPickerValueConverter : PropertyValueConverterBase, IPropertyValueConverterMeta
    {
        /// <summary>
        ...
        {
            Umbraco.Core.Constants.Conventions.Content.InternalRedirectId.ToLower(CultureInfo.InvariantCulture),
            Umbraco.Core.Constants.Conventions.Content.Redirect.ToLower(CultureInfo.InvariantCulture)
        };
        ...
        {
            return propertyType.PropertyEditorAlias.Equals("TwoWayPicker");
        }
