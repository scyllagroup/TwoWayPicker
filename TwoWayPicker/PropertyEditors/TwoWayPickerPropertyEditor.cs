...
{
    /*
    [PropertyEditor("TwoWayPicker", "Two Way Picker", "contentpicker", Group = "pickers", Icon = "icon-page-add")]
    public class TwoWayPickerPropertyEditor : PropertyEditor
    {
        public TwoWayPickerPropertyEditor()
        {
