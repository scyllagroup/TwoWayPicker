...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "42e704d2a35716c7")]
...
#pragma warning restore 0109
		...
		/// Home Picker
		///</summary>
		[ImplementPropertyType("homePicker")]
		public IEnumerable<IPublishedContent> HomePicker
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("homePicker"); }
		}
...
#pragma warning restore 0109
		...
		/// Two Way Picker
		///</summary>
		[ImplementPropertyType("twoWayPicker")]
		public IEnumerable<IPublishedContent> TwoWayPicker
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("twoWayPicker"); }
		}
	}
...
#pragma warning restore 0109
		...
		public IEnumerable<IPublishedContent> Family
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("family"); }
		}
	}

	/// <summary>Retired Product</summary>
	[PublishedContentModel("retiredProduct")]
	public partial class RetiredProduct : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "retiredProduct";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public RetiredProduct(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<RetiredProduct, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	...
	[PublishedContentModel("productFamily")]
	public partial class ProductFamily : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "productFamily";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ProductFamily(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ProductFamily, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Products & Retired Products
		///</summary>
...
#pragma warning restore 0109
		...
		/// Member to home
		///</summary>
		[ImplementPropertyType("memberToHome")]
		public IEnumerable<IPublishedContent> MemberToHome
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("memberToHome"); }
		}
